...
const CarritoIcono = () => {
  ...
  return (
    <div
      className="p-5 cart-container"
      onClick={() => toggleMostrarElementos()}
    >
          ...
          {mostrarElementos && (
            <div className="absolute w-full  rounded-b border-t-0 z-10">
              <div className="shadow-xl w-64">
                {cursos.map((curso) => (
                  <div key={curso.id} className="p-2 flex bg-white hover:bg-gray-100 cursor-pointer border-b border-gray-100">
